...
/**
 * Один тип — одно предупреждение за жизнь страницы.
 *
 * @param {string} type значение `type` блока, который не удалось показать.
 * @returns {boolean} ругнулись ли сейчас (`false` — про этот тип уже говорили).
 */
